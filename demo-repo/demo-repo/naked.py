...
#API atslēga lai piekļūtu nasa API
nasa_api_key = "mS0ljSggBigs9TAZcCgel5fTeATnbgIx2UONOE8t"
...
if r.status_code == 200:
	...
	#saraksti priekš asteroīdiem pēc bīstamības
	ast_safe = []
	ast_hazardous = []

	if 'element_count' in json_data:
		ast_count = int(json_data['element_count'])
		#izvada cik asteroīdi bijuši šodien
		...
		if ast_count > 0:
			for val in json_data['near_earth_objects'][request_date]:
				if 'name' and 'nasa_jpl_url' and 'estimated_diameter' and 'is_potentially_hazardous_asteroid' and 'close_approach_data' in val:
					...
					#Aprēķins priekš asteroīdu bīstamības noteikšanas
